        ...
        <footer className="pt-1 bg-gray" style={{backgroundColor: "#F5F6F8"}}>
            <div className="container">
                <div className="d-flex pt-2 copyright">
                    ...
                    <p className="mb-3">
                        <a href="https://play.google.com/store/apps/details?id=com.ecobots.ecochatsapp&amp;hl=en_US" className="text-decoration-none text-reset fs-6 fw-normal lh-sm d-flex align-items-center u-w-fit">
                    ...
                    <p className="mb-3 u-w-fit">
                        <a href="https://apps.apple.com/se/app/ecobots/id6451185273" className="text-decoration-none text-reset fs-6 fw-normal lh-sm d-flex align-items-center u-w-fit">
